...
function initScene() {
	...
	loader.load('models/weirdObject_texture.obj', function (object) {
        ...
        const scale = 5.0 / maxDimension;  // Adjust scale here to make the object larger
        object.scale.set(scale, scale, scale);

        // Center the object based on the scaled size
        const scaledCenter = center.multiplyScalar(scale);
        object.position.set(-scaledCenter.x, -scaledCenter.y + (size.y * scale / 2), -scaledCenter.z);
